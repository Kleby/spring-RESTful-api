package me.jkleby.santander.bootcamp.controller.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleNotFoundExecption(NoSuchElementException notFoundException){
